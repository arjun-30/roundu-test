...
import { getProviderDashboard, searchProviders, registerProvider, updateServiceRadius, updateWorkingHours, checkProviderExists } from '../controllers/provider.controller';
