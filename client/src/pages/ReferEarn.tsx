  ...
  return (
    <div className="min-h-full flex flex-col bg-background pb-10 relative overflow-hidden">
      ...
      <div className="flex-1 px-6 space-y-6 relative z-10 pt-4 overflow-y-auto">
        ...
        {/* Leaderboard */}
        <button className="w-full flex items-center justify-between p-5 rounded-3xl bg-secondary text-secondary-foreground shadow-lg animate-fade-in" style={{ animationDelay: "0.4s" }}>
